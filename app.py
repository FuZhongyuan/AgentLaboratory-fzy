...
print("Ready to load a pre-trained sentence transformer model")
# import safetensors_rust
# safetensors_rust.set_header_size_limit(1024 * 1024 * 1000)  # 设置头部大小限制为1000MB
model = SentenceTransformer('./hugging-face/m3e-base')
print("Load a pre-trained sentence transformer model")
